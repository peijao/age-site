  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-900 dark:text-gray-100 text-base mb-6">
          <motion.button
            onClick={openGeo}
        ...
        <p className="text-gray-900 dark:text-gray-100 text-base mb-10 text-center">
          <motion.a
            href="/documents/PMFD-2762-9ADA-716D.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="font-bold border-b-2 border-black dark:border-white leading-none normal-case inline-flex items-center gap-2 cursor-pointer text-black dark:text-white"
            whileHover={hoverAnimation}
